    ...
    function node_modulesNgxMaterialFileInput__ivy_ngcc__Fesm2015NgxMaterialFileInputJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FileInputComponent = FileInputComponent_1 = /*#__PURE__*/function (_FileInputMixinBase) {
        ...
        function FileInputComponent(fm, _elementRef, _renderer, _defaultErrorStateMatcher, ngControl, _parentForm, _parentFormGroup) {
          ...
          _this7 = _super4.call(this, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
          _this7.fm = fm;
          _this7._elementRef = _elementRef;
          _this7._renderer = _renderer;
          _this7._defaultErrorStateMatcher = _defaultErrorStateMatcher;
          _this7.ngControl = ngControl;
          _this7._parentForm = _parentForm;
          _this7._parentFormGroup = _parentFormGroup;
          _this7.focused = false;
          _this7.controlType = 'file-input';
          _this7.autofilled = false;
          _this7._required = false;
          _this7.accept = null;
          _this7.id = "ngx-mat-file-input-".concat(FileInputComponent_1.nextId++);
          _this7.describedBy = '';
          ...
          if (_this7.ngControl != null) {
            _this7.ngControl.valueAccessor = _assertThisInitialized(_this7);
          }

          fm.monitor(_elementRef.nativeElement, true).subscribe(function (origin) {
            _this7.focused = !!origin;
